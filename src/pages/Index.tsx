...
import { Home, ShoppingCart, Package, Car, Gamepad2 } from "lucide-react";
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {features.map((feature, index) => (
          <Link to={feature.path} key={index} className="no-underline text-foreground">
            <Card className={`h-full transition-all hover:shadow-lg ${feature.color} hover:-translate-y-1`}>
